...
HD_PWD='C:/Users/Jose Perez Flores/Documents/EE_PROJECTS/seg_display_demo/seg_display_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seg_top.tcl

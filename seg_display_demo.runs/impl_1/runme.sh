...
HD_PWD='C:/Users/Jose Perez Flores/Documents/EE_PROJECTS/seg_display_demo/seg_display_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seg_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seg_top.tcl -notrace
